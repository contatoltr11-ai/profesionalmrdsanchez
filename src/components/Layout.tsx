...
// Flag para evitar injeção duplicada da Utmify (StrictMode / re-renders)
let utmifyInjected = false;

export default function Layout({ children }: LayoutProps) {

  useEffect(() => {
    // ========================================
    // ✅ GOOGLE TAG MANAGER (GUARD PRÓPRIO)
    // ========================================
